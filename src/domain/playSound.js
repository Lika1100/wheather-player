...
var currenTSoundKey;
var isPaused = false;
function playSound(_a) {
    var soundKey = _a.soundKey, bgImage = _a.bgImage, sounds = _a.sounds, bg = _a.bg;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4:
                    bg.style.backgroundImage = "url(".concat(require("../assets/images/".concat(bgImage)), ")");
                    return [2 /*return*/];
            }
        });
    });
